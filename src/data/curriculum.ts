...
export const courseStages: CourseStage[] = [
  ...
  },
  {
    ...
    index: 3,
    title: '字根微包',
    description: '每次 15 个，看根输码；学完一小包就立刻进入真实汉字。',
    kind: 'roots',
    target: '241 个字根',
    minutes: 10,
  },
  {
    ...
    index: 4,
    title: '看懂拆分',
    description: '从左右、上下开始，只在答错时解释字架、切字和走之底。',
    kind: 'splits',
    target: '必拆案例',
    minutes: 8,
  },
...
export const splitExamples: SplitEntry[] = [
  ...
  { char: '颦', roots: ['止', '𣥂', '页', '白', '丿', '十'], code: 'sswn', note: '五根以上只取前三根与末根。', rule: 'order' },
  ...
  { char: '鬯', roots: ['𠂭', '凵', '匕'], code: 'pmvb', note: '框的开口方向决定使用哪个字根。', rule: 'frame' },
  { char: '过', roots: ['寸', '辶'], code: 'kuc', note: '走之底按笔顺最后取。', rule: 'walk' },
  { char: '廷', roots: ['丿', '土', '廴'], code: 'tguy', note: '建之底和走之底一样最后取。', rule: 'walk' },
  ...
  { char: '国', roots: ['囗', '王', '丶'], code: 'rnid', note: '里面有内容的四面框使用囗。', rule: 'frame' },
  { char: '回', roots: ['囗', '口'], code: 'rdk', note: '外面是框囗，里面是口。', rule: 'frame' },
