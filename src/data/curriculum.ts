...
export const splitExamples: SplitEntry[] = [
  ...
  { char: '匡', roots: ['匚', '王'], code: 'nnw', note: '外框匚向右开口，根码 Nk。', rule: 'order' },
  { char: '鬯', roots: ['𠂭', '凵', '匕'], rootCodes: ['pm', 'mk', 'vb'], code: 'pmvb', note: '框的开口方向决定使用哪个字根。', rule: 'order' },
  { char: '过', roots: ['寸', '辶'], code: 'kuc', note: '走之底按笔顺最后取。', rule: 'walk' },
  { char: '廷', roots: ['丿', '士', '廴'], code: 'tguy', note: '建之底和走之底一样最后取。', rule: 'walk' },
  { char: '果', roots: ['田', '木'], code: 'qem', note: '必要时允许一次切字，用于离析糅合在一起的字根。', rule: 'cut' },
  { char: '丝', roots: ['纟', '纟'], code: 'iis', note: '底部横画被纵向切开，得到两个纟。', rule: 'cut' },
  ...
  { char: '国', roots: ['囗', '王', '丶'], rootCodes: ['rk', 'nw', 'id'], code: 'rnid', note: '里面有内容的四面框使用囗。', rule: 'box' },
  { char: '回', roots: ['囗', '口'], rootCodes: ['rk', 'dk'], code: 'rdk', note: '外面是框囗，里面是口。', rule: 'box' },
